    ...
    private void getWeather() {
        Thread t = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                String latitude = pref.getString(Constants.APP_SETTINGS_LATITUDE, "21.59");
                String longitude = pref.getString(Constants.APP_SETTINGS_LONGITUDE, "105.84");
