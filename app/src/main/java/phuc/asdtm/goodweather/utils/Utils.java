...
public class Utils {
    ...
    private static String getCityAndCountryFromGeolocation(SharedPreferences preferences) {
        String geoCountryName = preferences.getString(Constants.APP_SETTINGS_GEO_COUNTRY_NAME, "VN");
        String geoCity = preferences.getString(Constants.APP_SETTINGS_GEO_CITY, "Thai Nguyen");
        if("".equals(geoCity)) {
