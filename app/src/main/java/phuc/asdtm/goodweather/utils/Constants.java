package phuc.asdtm.goodweather.utils;
...
public class Constants {
    ...
    public static final String KEY_PREF_ABOUT_OPEN_SOURCE_LICENSES = "about_open_source_licenses_pref_key";
    ...
    public static final String ACTION_FORCED_APPWIDGET_UPDATE =
            "phuc.asdtm.goodweather.action.FORCED_APPWIDGET_UPDATE";
    public static final String ACTION_APPWIDGET_THEME_CHANGED =
            "phuc.asdtm.goodweather.action.APPWIDGET_THEME_CHANGED";
    public static final String ACTION_APPWIDGET_UPDATE_PERIOD_CHANGED =
            "phuc.asdtm.goodweather.action.APPWIDGET_UPDATE_PERIOD_CHANGED";
    ...
    public static final String GOOGLE_PLAY_WEB_URI = "https://play.google.com/store/apps/details?id=%s";
