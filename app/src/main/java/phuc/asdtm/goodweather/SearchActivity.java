...
import phuc.asdtm.goodweather.model.CitySearch;
import phuc.asdtm.goodweather.utils.CityParser;
...
public class SearchActivity extends AppCompatActivity {
    ...
    private void loadLastFoundCity() {
        if (mCites.isEmpty()) {
            String lastCity = mCityPref.getString(APP_SETTINGS_CITY, "Thai Nguyen");
            String lastCountry = mCityPref.getString(APP_SETTINGS_COUNTRY_CODE, "VN");
            String lastLat = mCityPref.getString(APP_SETTINGS_LATITUDE, "21.59");
            String lastLon = mCityPref.getString(APP_SETTINGS_LONGITUDE, "105.84");
