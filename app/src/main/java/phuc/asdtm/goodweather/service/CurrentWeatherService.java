package phuc.asdtm.goodweather.service;
...
import phuc.asdtm.goodweather.ConnectionDetector;
import phuc.asdtm.goodweather.utils.AppPreference;
import phuc.asdtm.goodweather.utils.Constants;
import phuc.asdtm.goodweather.utils.LanguageUtil;
import phuc.asdtm.goodweather.utils.PreferenceUtil;
import phuc.asdtm.goodweather.utils.Utils;
...
import static phuc.asdtm.goodweather.MainActivity.mCitySearch;
import static phuc.asdtm.goodweather.MainActivity.mWeather;

public class CurrentWeatherService extends IntentService {

    private static final String TAG = "WeatherService";

    public static final String ACTION_WEATHER_UPDATE_OK = "phuc.asdtm.goodweather.action.WEATHER_UPDATE_OK";
    public static final String ACTION_WEATHER_UPDATE_FAIL = "phuc.asdtm.goodweather.action.WEATHER_UPDATE_FAIL";
    public static final String ACTION_WEATHER_UPDATE_RESULT = "phuc.asdtm.goodweather.action.WEATHER_UPDATE_RESULT";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        String latitude = preferences.getString(Constants.APP_SETTINGS_LATITUDE, "21.59");//51.51
        String longitude = preferences.getString(Constants.APP_SETTINGS_LONGITUDE, "105.84");//-0.13
